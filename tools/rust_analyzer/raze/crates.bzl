...
def rr_tra_fetch_remote_crates():
    ...
    maybe(
        http_archive,
        name = "rr_tra__hermit_abi__0_1_18",
    ...
    maybe(
        http_archive,
        name = "rr_tra__proc_macro2__1_0_24",
    ...
    maybe(
        http_archive,
        name = "rr_tra__structopt__0_3_21",
    ...
    maybe(
        http_archive,
        name = "rr_tra__structopt_derive__0_4_14",
    ...
    maybe(
        http_archive,
        name = "rr_tra__unicode_segmentation__1_7_1",
    ...
    maybe(
        http_archive,
        name = "rr_tra__unicode_width__0_1_8",
    ...
    maybe(
        http_archive,
        name = "rr_tra__unicode_xid__0_2_1",
    ...
    maybe(
        http_archive,
        name = "rr_tra__version_check__0_9_2",
